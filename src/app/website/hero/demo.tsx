...
function LandingHero() {
  return (
    <section className="w-full min-h-screen overflow-hidden md:overflow-invisible flex flex-col items-center justify-center relative bg-gradient-to-b from-black via-gray-900 to-black z-[-10]">
      ...
      <div className="flex flex-col justify-center items-center w-[250px] sm:w-[300px] md:w-[500px] lg:w-[700px] z-50 pointer-events-auto">
        ...
        >
          ...
          <LayoutGroup>
            <motion.span layout className="flex whitespace-pre">
              <motion.span
                layout
                className="flex whitespace-pre text-white"
        ...
        <motion.p
          className="text-sm sm:text-lg md:text-xl lg:text-2xl text-center text-gray-300 font-overusedGrotesk pt-4 sm:pt-8 md:pt-10 lg:pt-12"
          animate={{ opacity: 1, y: 0 }}
          initial={{ opacity: 0, y: 20 }}
        ...
        <div className="flex flex-row justify-center space-x-4 items-center mt-10 sm:mt-16 md:mt-20 lg:mt-20 text-xs">
          ...
          >
            <Link href="/docs/introduction" className="text-black">
              Check docs <span className="font-serif ml-1 text-black">→</span>
            </Link>
          </motion.button>
          <motion.button
